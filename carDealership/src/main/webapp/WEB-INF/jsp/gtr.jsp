				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
					<div class="col">
						<div class="card shadow-sm">
							<img alt="2021 Nissan GTR" src="./images/gtr.jpg" width="100%"
								height="225">

							<div class="card-body">
								<p class="card-text">This is where I'll use a for each loop
									to display all the car objects attributes. I also want to
									resize this to take up the majority of the body of this page.</p>
								<div class="d-flex justify-content-between align-items-center">
									<div class="btn-group">
										<a type="button" class="btn btn-sm btn-outline-secondary"
											href="/login">Purchase</a> <a type="button"
											class="btn btn-sm btn-outline-secondary" href="/login">Edit</a>
									</div>
									<small class="text-muted">$17,950</small>
								</div>
							</div>
						</div>
					</div>
